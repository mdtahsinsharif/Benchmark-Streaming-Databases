...
CREATE TABLE nexmark_q10 (
  ...
  'path' = 'file:///srv/nfs/flink/nexmark/scalability/q10/p30/${SUBMIT_TIME}/bid/',
  'format' = 'csv',
...
SELECT auction, bidder, price, `dateTime`, extra, DATE_FORMAT(`dateTime`, 'yyyy-MM-dd'), DATE_FORMAT(`dateTime`, 'HH:mm'), CURRENT_TIMESTAMP AS processed_time
FROM bid;